...
{
    public class EmployeWidgetListPartDisplayDriver : ContentPartDisplayDriver<EmployeWidgetListPart>
    {
        private readonly IOrchardHelper _orchardHelper;

        public EmployeWidgetListPartDisplayDriver(IOrchardHelper orchardHelper)
        {
            _orchardHelper = orchardHelper;
        }
        public override IDisplayResult Display(EmployeWidgetListPart part, BuildPartDisplayContext context)
        {
