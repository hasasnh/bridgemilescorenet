...
require('@/js/vendors/plugins/select2.init.js');

// Flatpickr - is a lightweight and powerful datetime picker.
require('flatpickr/dist/flatpickr.min.js');
require('@/js/vendors/plugins/flatpickr.init.js');
...
require('@/js/vendors/plugins/dropzone.init.js');
